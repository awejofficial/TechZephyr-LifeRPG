...
import { History, Trophy, Coins, Clock, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs sm:text-sm text-muted-foreground mt-1">
          Server-persisted history of all XP rewards, task completions, and anti-cheat event verification.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="p-12 text-center border-2 border-dashed border-border/80 rounded-2xl bg-card/30">
          ...
          <h3 className="font-bold text-base text-foreground">No History Recorded Yet</h3>
          <p className="text-xs text-muted-foreground mt-1">
            Complete your first quest to generate permanent chronological XP audit events.
          </p>
        </div>
      ) : (
