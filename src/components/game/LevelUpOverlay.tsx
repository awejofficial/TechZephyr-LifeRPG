...
export function LevelUpOverlay() {
  ...
  const AttrIcon = levelUpData ? attributeIcons[levelUpData.attribute] || Trophy : Trophy;
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              onClick={handleClose}
              autoFocus
              className="w-full py-3 px-6 rounded-xl bg-primary text-primary-foreground font-bold text-base shadow-lg hover:bg-primary/90 transition-colors flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
            >
